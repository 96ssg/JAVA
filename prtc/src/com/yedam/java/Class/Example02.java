...
public class Example02 {
	...
	public static void main(String[] args) {
		...
		// - 연봉은 12월치 월급여액에 한달치 월급여액 * 500%를 더한값으로 한다
		// - 기본 생성자에서 필드 salary의 초기 값을 사용하며, 정수형 매개변수를 가지는 생성자에서 해당 매개변수를
		// 월 급여액으로 저장
		...
		System.out.println("학생" + studentHong.getName() + "의 총 점수는" + studentHong.getTotal()+"이고, 평균은"+studentHong.getAverage
		()+"입니다.");
